...
<body>
	...
	<h1 style="text-align: center; margin: 20px auto;">후기게시판</h1>
		<table id="boardTable">
			<tr id="boardTrTag">
				<th>번호</th> <th>제목</th> <th>내용</th> <th>글쓴이</th> <th>등록날짜</th> <th>조회수</th>
			</tr>
				<%
			...
			<tr id="trTag">
				...
				<td style="width: 40%"><%=list.get(i).getBoardContent() %></td>
				...
				%>
			<tr>
				<td colspan="6"> <button id="insertBtn" type="button" onclick="location.href='insertContent.jsp'">글등록</button> </td>
			</tr>
		</table>
	</div>
	<!-- 게시판 영역 끝-->
